...
public:
   ...
   */
  void setHideShell(bool newHideShell) { this->hideShell = newHideShell; }
   ...
   */
  [[nodiscard]] const std::string &getOutputFile() const { return outputfile; }

  /**
   * @brief Getter for this->hideShell
   * @return The assigned value for hideshell
   */
  [[nodiscard]] bool getHideShell() const { return hideShell; }
