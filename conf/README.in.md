...
The documentation generated by doxygen for this project can be found
...
After building the project the man page can be accessed by:
```sh
man assets/man/@EXECUTABLE_NAME@.troff
```
